...
FSelectableItemClass.prototype.setHighlighted = function(flag)
{
   var _loc1_ = this;
   var _loc3_ = flag;
   var _loc2_ = _loc1_.controller.styleTable.fadeRate.value;
   if(_loc2_ == undefined || _loc2_ == 0 || !_loc3_)
   {
      _loc1_.highlight_mc._alpha = !_loc3_ ? 0 : 100;
